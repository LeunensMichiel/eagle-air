    ...
    <section className={cn('py-container', styles.import)}>
          ...
          <div className={styles.import__intro__inner}>
            <div>
              <p className="paragraph">
                Wij kunnen inklaringen overal ter wereld aanbieden. Dit door ons
                eigen medewerkers of door betrouwbare agenten die zorgvuldig
                worden uitgekozen. Wij werken volgens de{' '}
                <strong>AEO standaard</strong>. Dit zorgt voor minder fouten en
                bijkomende controles.
              </p>
              <p className="paragraph">
                Wij beschikken over ons eigen douane-entrepot. Hierdoor kunnen
                wij jouw goederen opslaan in afwachting van de nodige documenten
      ...
      <div className={cn('container')}>
        <h2 className={styles.team__title}>
          Met hun jarenlange ervaring in de sector, biedt ons import team jou de
          beste service.
        ...
        <div className={styles.team}>
          ...
          <div className={styles.team__card}>
            <p>
              Onze medewerkers blijven zich bijscholen om jou steeds de nieuwste
              informatie te kunnen verschaffen.
            </p>
            <Link href="/contact" passHref>
              <Button iconRight={<Chevron />} variant="light" size="sm" as="a">
                Join the team
              </Button>
            </Link>
          </div>
